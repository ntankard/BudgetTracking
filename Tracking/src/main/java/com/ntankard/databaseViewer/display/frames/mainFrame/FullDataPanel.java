...
public class FullDataPanel extends UpdatableJPanel {
    ...
    private DataObject_DisplayList<SaveInstance> saveInstance_panel;
    private DataObject_DisplayList<File> savedDataObject_panel;
    private DataObject_DisplayList<Row> savedLine_panel;
    private DataObject_DisplayList<Cell> savedField_panel;
    ...
    private void createUIComponents() {
        ...
        saveInstance_panel = new DataObject_DisplayList<>(database.getSchema(), SaveInstance.class, new Full_Set<>(database, SaveInstance.class), false, this);
        ...
        savedDataObject_panel = new DataObject_DisplayList<>(database.getSchema(), File.class, savedDataObject_set, false, this);
        ...
        savedLine_panel = new DataObject_DisplayList<>(database.getSchema(), Row.class, savedLine_set, false, this);
        ...
        savedField_panel = new DataObject_DisplayList<>(database.getSchema(), Cell.class, savedField_set, false, this);
