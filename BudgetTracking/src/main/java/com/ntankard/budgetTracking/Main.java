...
import com.ntankard.budgetTracking.dispaly.frames.mainFrame.Master_Frame;
...
public class Main {
    ...
    public static Database createDataBase(List<Class<? extends DataObject>> solidClasses) {
        Map<String, String> nameMap = new HashMap<>();
        return Database_IO.read(Database_Schema.getSchemaFromPackage(databasePath, solidClasses), databasePath, savePath, nameMap);
    }
