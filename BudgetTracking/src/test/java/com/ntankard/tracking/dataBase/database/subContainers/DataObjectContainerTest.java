//package com.ntankard.budgetTracking.dataBase.database.subContainers;
//
...
//
//        Layer1_ALT_DataObject_New(Database database, Integer id) {
//            super(database);
//            this.id = id;
//        }
//
...
//        private final Integer id;
//
//        Layer1_DataObject_New(Database database, Integer id) {
//            super(database);
//            this.id = id;
//        }
//
...
//        Layer2_DataObject_New(Database database, Integer id) {
//            super(database, id);
//        }
//    }
//
//    private static class Layer3_DataObject_New extends Layer2_DataObject_New {
//        Layer3_DataObject_New(Database database, Integer id) {
//            super(database, id);
//        }
//    }
//}
